...
Gem::Specification.new do |spec|
  spec.name          = 'arges'
  spec.version       = Arges::VERSION
  spec.authors       = ['Šimon Lukašík']
  spec.email         = ['isimluk@fedoraproject.org']

  spec.summary       = 'Calculates ROE from transaction log'
  spec.description   = spec.summary
  spec.homepage      = 'https://github.com/isimluk/ares'
  spec.license       = 'MIT'
